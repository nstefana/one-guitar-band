...
- Bass production: by playing a melodic line of the first three strings of the guitar (from E1 to A2), the user can program a bass line.
...
- Recording: the input signal can be recorded as in a normal looper application.
...
- Post processing: optionally the user can active quantization functionalities for correcting temporal inaccuracies produced during Bass, Drums and Cymbal production.
- Load and save functionalities: the user can save all system settings and recorded/produced instruments. They can be recalled at a later point to continue working on the composition.
- Exporting to DAW: selected layers from selected instruments can be exported as .wav files. The user can then import these files in the DAW of his/her preference to continue work.
...
- Flexibility: Most important functionalities can be triggered also from an external MIDI controller. 
