...
The system incorporates several sound production functionalities, including that of a looper. At each repetition of the loop, the user interact with either one of the following sound production mechanisms:
...
- Exporting to DAW: selected layers from selected instruments can be exported as .wav files. The user can then import these files in the DAW of his/her preference to continue working on his composition.
